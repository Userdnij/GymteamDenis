...
export const ChooseDateModal = ({open, setOpen, submit, summa, product, onSubmit, term, setTerm}) => {
                ...
                <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-start">
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      <div className="mt-10">
                        <div>
                            <p className="InputLabel">Produkts: Abonements {product}</p>
                        </div>

                        <div className="mt-5 flex">
                            <p className="InputLabel mt-1">Izvelies termiņu:</p>
                            <select className="Select ml-5" value={term} onChange={setTerm}>
